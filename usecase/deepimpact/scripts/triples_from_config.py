...
temporalities = TemporalityConverter(pd.read_csv(os.path.join(args.config_input_folder, "config_temporalities.tsv"), header=0, index_col=0, sep="\t"))
sensors = SensorConverter(pd.read_csv(os.path.join(args.config_input_folder, "config_sensors.tsv"), header=0, index_col=0, sep="\t"))
...
constraints = ConstraintConverter(pd.read_csv(os.path.join(args.config_input_folder, "config_constraints.tsv"), header=0, index_col=0, sep="\t"))
