...
bioagressors_lab_details = pd.read_csv(os.path.join(args.input_data, "bioagressors_lab.tsv"), header=0, index_col=0, sep="\t")
bioagressors_field_details = pd.read_csv(os.path.join(args.input_data, "bioagressors_field_details.tsv"), header=0, index_col=0, sep="\t")
...
bioagressors_field_details = DPUseCaseBioagressorsDetailsConverter(bioagressors_field_details)
bioagressors_lab_details = DPUseCaseBioagressorsLabConverter(bioagressors_lab_details)
...
bioagressors_field_general.convert(config_variables, os.path.join(args.output_dir, "observations_bioagressors_fields_general.tsv"))
print("bioagressors field details...")
bioagressors_field_details.convert(config_variables, "FieldSampled", os.path.join(args.output_dir, "observations_bioagressors_fields_details.tsv"))
# print("bioagressors lab...")
# bioagressors_lab_details.convert(config_variables, "LabSampled", os.path.join(args.output_dir, "observations_bioagressors_lab.tsv"))
# print("climatic...")
