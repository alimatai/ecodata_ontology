...
parser.add_argument("-c", "--configtable", help="csv/tsv file describing the dataset")
parser.add_argument("-p", "--projectprefix", help="prefix that will used to the project instances")
args=parser.parse_args()

def main():

	table = TxtParser(args.configtable, "\t")
	configloader = ConfigTurtleConverter(args.projectprefix, table)
